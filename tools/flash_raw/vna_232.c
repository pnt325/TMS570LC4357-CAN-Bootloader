...
*/
uint8_t
vna_232_cksum ( uint8_t *buf, uint16_t size )
{
  uint8_t ret = 0;
...
*/
uint16_t
vna_232_bs ( uint8_t *dst, uint8_t *src, uint16_t buf_len )
{
  uint16_t cnt;
  uint8_t *prev = dst;
...
*/
void
vna_232_tx_msg ( uint8_t *buf, uint16_t buf_len )
{
  uint16_t cnt;
  uint8_t msg[1000];
  uint8_t msg_bs[2000];
...
*/
uint16_t
vna_232_rx_msg ( uint8_t *msg, uint16_t msg_size )
{
  uint8_t val;
  uint16_t cnt;
  static uint16_t i = 0;
