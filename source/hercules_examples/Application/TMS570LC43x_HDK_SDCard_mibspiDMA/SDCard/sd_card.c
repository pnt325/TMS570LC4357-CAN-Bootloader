...
//
//*****************************************************************************
#pragma DATA_SECTION(g_pcTmpBuf, "SD_RDATA_SECTION")    //QJ, added in sept 2020
...
//
//*****************************************************************************
#pragma DATA_SECTION(g_sFileObject, "SD_RDATA_SECTION")    //QJ, added in sept 2020
...
Cmd_cat(int argc, char *argv[])
{
    ...
    do
    {
        ...
        /* Check if the received data is 5A5A... if 123.txt is opened */
        /* 0x35 -- '5'; 0x41---'A'; 0x0D -- carriage return; 0x0A -- new line; 0x00 -- null */
//        for(i=0; i<(sizeof(g_pcTmpBuf) - 1); i++){
//            abc = g_pcTmpBuf[i];
//            if (g_pcTmpBuf[i] != 0x35)
//                if (g_pcTmpBuf[i] != 0x41)
//                    if (g_pcTmpBuf[i] != 0x0D)
//                        if (g_pcTmpBuf[i] != 0x0A)
//                            if (g_pcTmpBuf[i] != 0x00)
//                                   errCount++;
//        }
...
//    UARTprintf("\r Error Count: \r");
//    UARTprintf("%4u", errCount);
