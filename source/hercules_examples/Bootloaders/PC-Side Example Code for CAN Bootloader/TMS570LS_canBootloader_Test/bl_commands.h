...
#define CAN_COMMAND_PING         (CAN_API_UPD | 0) << 0         //0x5A0
#define CAN_COMMAND_DOWNLOAD     (CAN_API_UPD | 1) << 0         //0x5A1
#define CAN_COMMAND_RUN          (CAN_API_UPD | 2) << 0         //0x5A2
#define CAN_COMMAND_SEND_DATA    (CAN_API_UPD | 4) << 0         //0x5A4
#define CAN_COMMAND_RESET        (CAN_API_UPD | 5) << 0         //0x5A5
#define CAN_COMMAND_ACK          (CAN_API_UPD | 6) << 0         //0x5A6
